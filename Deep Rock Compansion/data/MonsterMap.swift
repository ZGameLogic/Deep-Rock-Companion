    ...
    init(){
        monsters = [
            ...
            Monster(id: 11,
                    ...
                    rockInStone: false),
            Monster(id: 12,
                    name: "Naedocyte Hatchlings",
                    description: "When not full health, roll 1 damage die only",
                    image: "Hatchling",
                    health: 3,
                    range: 1,
                    movement: 3,
                    damageDie: ["HitDie", "HitDie"],
                    specials: ["Stunned"],
                    resistences: ["Axe", "Stunned"],
                    rockInStone: false),
            Monster(id: 13,
                    name: "Naedocyte Breeder",
                    description: "Ignore bite results",
                    image: "Breeder",
                    health: 4,
                    range: 1,
                    movement: 3,
                    damageDie: ["HitDie", "HitDie"],
                    specials: ["hatchling-icon"],
                    resistences: ["Axe", "Stunned", "Frozen"],
                    rockInStone: false),
            Monster(id: 14,
                    name: "Q'Ronar Shellback",
                    description: "Note that the Fast Critters event card can cause the Shellback to deal damage to a target twice in the same event phase.",
                    image: "Shellback",
                    health: 3,
                    range: 5,
                    movement: 5,
                    damageDie: ["HitDie"],
                    specials: ["KnockBack", "Damage"],
                    resistences: ["Bullet", "Stunned", "Frozen"],
                    rockInStone: false),
            Monster(id: 15,
                    name: "Rammer",
                    description: "Note that the Fast Critters event card can cause the Shellback to deal damage to a target twice in the same event phase.",
            ...
            Monster(id: 16,
                    ...
                    damageDie: ["HitDie"],
                    specials: ["Stunned"],
                    resistences: ["Axe", "Fire"],
                    rockInStone: false),
            Monster(id: 17,
                    name: "Bulk Detonator",
                    description: "When killed, roll 2 eplosion die and deal that in a range of 2.",
                    image: "Bulk-Detinator",
                    health: 8,
                    range: 2,
                    movement: 3,
                    damageDie: ["HitDie"],
                    specials: ["Stunned", "Damage"],
                    resistences: ["Explosive", "Fire"],
                    rockInStone: true),
            Monster(id: 18,
                    name: "Tyrant-Weed",
                    description: "The heart clam can only be damaged as long as two or more of the other parts are gone. Reward is a mineral die roll, 2 throwables and 2 Rock in Stone cards.",
                    image: "Tyrant-Weed",
                    health: 8,
                    range: 0,
                    movement: 0,
                    damageDie: [],
                    specials: [],
                    resistences: ["Stunned", "Pierce", "Bullet"],
                    rockInStone: true),
            Monster(id: 19,
                    name: "TW Sprout",
                    description: "Shoots at nearest target, or regrows on (or close to) spawn point, upon activation.",
                    image: "Korlok-Sprout",
                    health: 1,
                    range: 7,
                    movement: 0,
            ...
            Monster(id: 20,
                    name: "TW Healing Pod",
                    description: "Heals Heart-Clam with 1 Health, or regrows on (or close to) spawn point, upon activation.",
                    image: "Healing-Pod",
                    health: 1,
                    range: 0,
                    movement: 0,
