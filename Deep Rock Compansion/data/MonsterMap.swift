    ...
    init(){
        monsters = [
            ...
            Monster(name: "Brood Nexus",
                    ...
                    rockInStone: false),
            Monster(name: "Spitball Infector",
