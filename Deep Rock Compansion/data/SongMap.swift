...
struct SongMap {
    ...
    init(){
        songs = [
            ...
            Song(file: "Horrors of Hoxxes", type: "Boss Music"),
            ...
            Song(file: "Fighting the Shadows", type: "Boss Music"),
            ...
            Song(file: "A Distant Terror", type: "Boss Music"),
            ...
            Song(file: "Dance of the Dreadnought", type: "Boss Music"),
            Song(file: "Dance of the Dreadnought", type: "swarm"),
            Song(file: "Interstellar Nightmares", type: "Boss Music"),
